...
#include "z1863905_project5_PageTableEntry.h"  //contains the struct for a PageTableEntry
#include "z1863905_project5_PhysicalMemory.h" //contains the class PhysicalMemory
#include "z1863905_project5_PageTable.h"  //contains the class PageTable
...
//this function accepts a string item name and returns the item's matching virtual page index
int itemToPageID(string itemIn)
{
  //for each item in the virtual memory list
  for(long unsigned int i = 0; i < virtualMemoryList.size(); i++)
  {
...
int main(int argc, char *argv[])
{
  ...
  for(long unsigned int i = 0; i < runList.size(); i++)
  {
